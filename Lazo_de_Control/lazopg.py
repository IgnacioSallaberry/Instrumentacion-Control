...
with nidaqmx.Task() as rtask: 
    ...
    while True:
        with nidaqmx.Task() as wtask:
            wtask.co_channels.add_co_pulse_chan_freq('Dev{}/ctr0'.format(numero_de_dispositivo), freq=336, duty_cycle=act) #366 es el maximo valor de frecuencia
            ...
            i_term += error
            d_term = delta_error        
            act = act + p_term + ki * i_term + kd * d_term
